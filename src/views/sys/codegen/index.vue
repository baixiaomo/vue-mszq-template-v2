<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableData" style="width: 100%">
      ...
      <el-table-column label="所属库" min-width="160" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="表注释" min-width="180" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.comments }}</span>
        </template>
      </el-table-column>

      <el-table-column label="创建时间" min-width="180" align="center" sortable>
        <template slot-scope="scope">
...
-->
    ...
    <el-dialog :append-to-body="true" :visible.sync="tableDialog" title="表详情" width="800px" max-height="800px">
      <el-table v-loading="loading" :data="dictDetailData" size="small" style="width: 100%;">
        ...
        <el-table-column prop="nullable" label="为空" />
      </el-table>
    </el-dialog>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" :loading="editLoading" @click="index">生成</el-button>
      </span>
    </el-dialog>
...
export default {
  ...
  methods: {
    logList: function() {
      ...
      params.append('schema', 'bcms')
      this.$api.index.table(params).then(response => {
        this.loading = false
    ...
    handleView(row) {
      if (row) {
        ...
        const params = new URLSearchParams()
        params.append('table', row.tableName)
        params.append('schema', row.tableSchema)
        this.$api.index.columns(params).then(res => {
